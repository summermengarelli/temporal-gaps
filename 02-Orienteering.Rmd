...
For this exercise, use either a dataset you have (bonus if it is at least 6 months since you last touched it!) or the [practice dataset provided](original_data.zip) (NOTE: clicking the link will download the dataset in a zipped folder called *original_data.zip*). With the [Review Log Template](ReviewLogTemplate.docx), curate the dataset.
