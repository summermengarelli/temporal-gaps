...
Another major reason to start data documentation now is that you may not be here when the project concludes and the data is ready to be archived or shared. It is very common for graduate students to join a project after it has started and/or graduate before it has ended. If this is the case for you, you will not have the opportunity to ensure that the data is archived with accurate and up-to-date documentation, but you *do* have the opportunity, right now, to ensure that when your work is shared with new collaborators, they have all the information they need. Writing a README now is your chance to record the TL;DR[^05-writing-1] of your efforts and contributions to the work, and well-formatted data documentation helps ensure that these best practices continue when you have moved on.

[^05-writing-1]: Too Long; Didn’t Read.

## Exercises

Complete the following documentation activities with either your own project files or the provided [example dataset](AnnotatingDocumenting.zip). (NOTE: clicking the links will download the datasets in a zipped folder called *AnnotatingDocumenting.zip*.)

1.  Fill out the [**README template**](README-template.txt) for your project files (for the sample dataset, you can reuse the existing README.txt file for this). We completed this exercise for the sample dataset, and you can view a completed README [HERE](README-completed.txt).
2.  Create a **data dictionary** for any tabular datasets. We completed this exercise for the sample file *speech_emotions.csv*, and you can view the completed data dictionary [HERE](dataDictionary.pdf).
