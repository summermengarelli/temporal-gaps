...
Just like we wrote a path to the Downloads folder before, we can construct a path to a given coursework file in this imaginary structure. Let’s say we’re interested in the *project_data.xlsx* file, which is in the subdirectory for the course *si676*. We’ll write the path assuming that it’s on a Windows machine belonging to the user *kevinq*. Which of the following is the correct path?
...
Complete the following file organization activities with either your own project files or the provided [example dataset](OrientingOrganizing.zip). If you would like an example of how to complete this exercise, we have applied the lesson to the example dataset [HERE](OrganizingAnnotating.zip), and you can review the changes we made in the Data Management Log. (NOTE: clicking the links will download the datasets in zipped folders.)

1.  Organize your project files! First, grab every file pertaining to your project that you have saved on your computer or in your drive, and put them all into one folder that is named intuitively to identify the project (for the example dataset, this has already been done). Then, develop a hierarchical folder structure within the project folder that makes sense for your project files and workflow, and sort your files into that structure. You may even find duplicated or unneeded data that can be deleted. **Document the organizational changes you made in your Data Management Log.**
2.  Fill out the [File Naming Convention Worksheet](FileNamingConventionWorksheet_Generic.pdf). If, after establishing your file naming convention, you change file names within your project folder, **document those changes in your Data Management Log**.

## Further Readings

-   [Navigating the file system](https://ucdavisdatalab.github.io/workshop_introduction_to_the_command_line/navigation.html): UC David DataLab lesson on file paths and navigating the file system.
-   [Naming and Organizing your Files and Folders worksheet](https://www.dropbox.com/scl/fi/1zd63iszw33rh4hjcu1dl/Worksheet_fileOrg.docx?rlkey=q0t25t1wttp4qx2p1ne39qfhd&dl=0) by MIT Libraries Data Management Services. Copyright © 2020-04-24 MASSACHUSETTS INSTITUTE OF TECHNOLOGY, licensed under a [Creative Commons Attribution 4.0 International License](https://creativecommons.org/licenses/by/4.0/) except where otherwise noted.
-   [File and Folder Organization](https://library.ucmerced.edu/file-and-folder-organization#:~:text=File%20Structures,want%20when%20looking%20up%20files) LibGuide from UC Merced.
-   Briney, Kristin A. (2020, June 2). [File Naming Convention Worksheet](https://doi.org/10.7907/894q-zr22). California Institute of Technology. <https://doi.org/10.7907/894q-zr22>.
