...
> “Programming is best regarded as the process of creating works of literature, which are meant to be read.” [^1] 
...
-   **docstring R package** to replicate docstrings in R: <https://cran.r-project.org/package=docstring>
-   **Global and Local Variables in Python** article: <https://www.geeksforgeeks.org/global-local-variables-python/>

[^1]: Donald Knuth, 'Computer Programming as an Art,' *Literate Programming*, (United States: Center for the Study of Language and Information, 1992): ix.
