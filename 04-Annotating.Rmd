...
Complete the following file organization activities with either your own project files or the provided [example dataset](OrganizingAnnotating.zip). (NOTE: clicking the link will download the dataset in a zipped folder called *organizingAnnotating.zip*.)

*If you would like an example of how to complete this exercise, we have applied the lesson to the script* 20240317_DNN_sp4_CS.py [*HERE*](20240317_DNN_sp4_CS.py)*.*

1.  Create and fill out a **header** at the top of your script. Include any relevant metadata, including your name and the names of anyone else who contributed to the script, an email by which you can be reached, when the script was created and why, and any other relevant information.
2.  Organize your code itself either into logical **sections** within the script, or broken into several different files as makes sense for your project.
3.  Add sufficient **comments** throughout your program to make it understandable to someone who does not code.
4.  Add an entry to your **Data Management Log** to note that you annotated/edited/changed your code.

Note: In the course of organizing and annotating your code, you may identify small errors (for example, importing a package twice) or ways that you can improve the script. It’s not a bad idea to use this step to clean up your code, but you can also decide to make notes for yourself to come back to later. Add comments that start with `TODO` near chunks you would like to revisit.
